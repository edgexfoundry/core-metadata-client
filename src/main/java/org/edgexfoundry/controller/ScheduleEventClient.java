...
public interface ScheduleEventClient {
	...
	List<ScheduleEvent> scheduleEventsForAddressable(@PathParam("addressableId") String addressableId);

	@GET
	@Path("/addressablename/{addressablename:.+}")
	List<ScheduleEvent> scheduleEventsForAddressableByName(@PathParam("addressablename") String addressablename);
