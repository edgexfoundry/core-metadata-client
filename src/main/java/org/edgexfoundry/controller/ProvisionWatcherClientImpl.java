...
@Component
public class ProvisionWatcherClientImpl extends ConsulDiscoveryClientTemplate implements ProvisionWatcherClient {
	...
	protected String extractPath() {
		...
		try {
			...
			throw new DataValidationException("the URL is malformed, meta.db.provisionwatcher.url: " + url);
		}
		return result;
	}
