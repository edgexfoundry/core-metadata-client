...
public interface DeviceServiceClient {
	...
	List<DeviceService> deviceServicesForAddressable(@PathParam("addressableId") String addressableId);

	@GET
	@Path("/addressablename/{addressablename:.+}")
	List<DeviceService> deviceServicesForAddressableByName(@PathParam("addressablename") String addressablename);
