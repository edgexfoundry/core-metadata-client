...
@Component
public class DeviceProfileClientImpl extends ConsulDiscoveryClientTemplate implements DeviceProfileClient {
	...
	@Override
	public List<DeviceProfile> deviceProfilesByManufacturerOrModel(String manufacturer, String model) {
